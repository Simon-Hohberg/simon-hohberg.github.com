...
var animate, camera, controls, height, i, init, mouseX, mouseY, onDocumentMouseMove, render, renderer, robot, robotInitCallback, scene, test, width, zmesh;
...
init = function() {
  ...
  robot = new Robot();
  return robot.loadRdf('js/rdf/robot2012/Robot2012.js', robotInitCallback);
};
...
test = function() {
  ...
  return scene.add(joint2.sceneNode);
};

robotInitCallback = function() {
