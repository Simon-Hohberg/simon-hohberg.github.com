...
function NetNode(posX, posY, radius, connectionPoinSize, color) {
  this.posX = posX;
  this.posY = posY;
  this.radius = radius;
  this.links = [];
...
NetNode.prototype.setPosition = function(posX, posY) {
  this.posX = posX;
  this.posY = posY;
  this.connectionPoints = [ {x: posX - this.radius, y: posY}, {x: posX + this.radius, y: posY} ];
}

NetNode.prototype.highlight = function() {
...
NetNode.prototype.unhighlight = function() {
...
NetNode.prototype.draw = function(paper) {
  if (this.radius > 0) {
...
function PillNetNode(posX, posY, width, height) {
  this.radius = 0;
  this.posX = posX;
  this.posY = posY;
  this.width = width;
...
PillNetNode.prototype = new NetNode();
PillNetNode.constructor = PillNetNode;
PillNetNode.prototype.setPosition = function(posX, posY) {
  this.posX = posX;
  this.posY = posY;
