...
/***/ "../../../../../src/app/post-loader.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PostLoaderService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("../../../common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_showdown__ = __webpack_require__("../../../../../src/lib/showdown.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_showdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__lib_showdown__);
...
var PostLoaderService = /** @class */ (function () {
    function PostLoaderService(http) {
        ...
        this.metaInfoRegex = /^(title|layout|thumbImg|keywords|thumbColor|thumbImgSrc|type|url|subtitle)\:\s*(.+)$/gm;
        this.idRegex = /(\d\d\d\d)-(\d\d)-(\d\d)-.+/;
        this.cache = new Map();
    }
    PostLoaderService.prototype.load = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            _this.http.get('./assets/' + id + '.md', { responseType: 'text' }).subscribe(function (data) {
                var idParts = _this.idRegex.exec(id);
                var postDate = new Date();
                postDate.setFullYear(parseInt(idParts[1]));
                postDate.setMonth(parseInt(idParts[2]) - 1);
                postDate.setDate(parseInt(idParts[3]));
                var postParts = _this.postRegex.exec(data);
                var title = postParts[2];
                var summary = postParts[3];
                var content = postParts[4];
                var post = new __WEBPACK_IMPORTED_MODULE_3__post__["a" /* Post */]();
                post.title = title;
                post.date = postDate;
                var metaInfo;
                while ((metaInfo = _this.metaInfoRegex.exec(postParts[1])) !== null) {
                    // Catch zero width matches
                    if (metaInfo.index === _this.metaInfoRegex.lastIndex) {
                        _this.metaInfoRegex.lastIndex++;
                    }
                    var metaKey = metaInfo[1];
                    var metaValue = metaInfo[2];
                    switch (metaKey) {
                        case "title":
                        ...
                        case "thumbImgSrc":
                            ...
                            break;
                        case "keywords":
                            post.keywords = metaValue.split(',').map(function (k) { return k.startsWith(' ') ? k.slice(1) : k; });
                            break;
                        case "thumbColor":
                ...
                __WEBPACK_IMPORTED_MODULE_2__lib_showdown__["setFlavor"]('github');
                __WEBPACK_IMPORTED_MODULE_2__lib_showdown__["setOption"]('tables', true);
                __WEBPACK_IMPORTED_MODULE_2__lib_showdown__["setOption"]('simpleLineBreaks', false);
                var converter = new __WEBPACK_IMPORTED_MODULE_2__lib_showdown__["Converter"]();
                var htmlContent = converter.makeHtml(content);
                post.content = htmlContent;
                var htmlSummary = converter.makeHtml(summary);
                post.summary = htmlSummary;
                _this.cache.set(id, post);
                resolve(post);
...
//# sourceMappingURL=post-loader.service.js.map

/***/ }),

/***/ "../../../../../src/app/post-thumb/post-thumb.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ":host {\n    color: rgb(60, 60, 60);\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: column;\n            flex-direction: column;\n}\n\n#imgThumbContainer {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    width: 300px;\n    height: 180px;\n    background-color: #464b65;\n}\n\nimg {\n    width: 250px;\n    max-width: 300px;\n    max-height: 180px;\n    height: auto;\n    /* background-color: #464b65; */\n}\n\n.text-container {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    box-sizing: border-box;\n    padding: 10px;\n    text-align: justify;\n}\n\n.keywords {\n    margin-right: 3px; \n    font-size: 12px;\n    -webkit-box-flex: 1;\n        -ms-flex-positive: 1;\n            flex-grow: 1;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: row;\n            flex-direction: row;\n    -ms-flex-wrap: wrap;\n        flex-wrap: wrap;\n}\n\n.keywords pre {\n    margin: 0;\n}\n\n.keywords pre:not(:last-child):after {\n    content: ', ';\n    text-decoration: none;\n}\n\n.info-line {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: row;\n            flex-direction: row;\n    width: 100%;\n    font-size: 14px;\n    color: rgb(150, 150, 150);\n}\n\nh2 {\n    text-align: center;\n    margin-bottom: 10px;\n}\n\nh3 {\n    text-align: center;\n    font-size: 16px;\n    font-weight: normal;\n    font-style: italic;\n}\n\n.summary {\n    padding: 0 10px 0 10px;\n}\n\n.summary p {\n    margin: 0;\n}", ""]);
...
/***/ "../../../../../src/app/post-thumb/post-thumb.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"imgThumbContainer\" [style.background-color]=\"post ? post.thumbColor : '#464b65'\" >\n  <img src=\"{{ post.imgThumbUrl }}\" alt=\"\">\n</div>\n<div class=\"text-container\">\n  <div class=\"info-line\">\n    <div class=\"keywords\">\n      <pre *ngFor=\"let k of post.keywords\">{{ k }}</pre>\n    </div>\n    <span class=\"filler\"></span>\n    <span>{{ getFormattedDate() }}</span>\n  </div>\n  <h2>{{ post.title }}</h2>\n  <h3 *ngIf=\"post.subtitle !== ''\">{{ post.subtitle }}</h3>\n  <div class=\"summary\" #summary></div>\n</div>"

/***/ }),

/***/ "../../../../../src/app/post-thumb/post-thumb.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PostThumbComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var PostThumbComponent = /** @class */ (function () {
    ...
    PostThumbComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (this.id) {
            this.postLoader.load(this.id).then(function (post) {
                _this.post = post;
                _this.summary.nativeElement.innerHTML = post.summary;
            });
        }
    };
    PostThumbComponent.prototype.getFormattedDate = function () {
        if (this.post) {
            var month = this.post.date.getMonth() + 1;
            var day = this.post.date.getDate();
    ...
    ], PostThumbComponent.prototype, "id", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('summary'),
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */]) === "function" && _a || Object)
    ], PostThumbComponent.prototype, "summary", void 0);
    PostThumbComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-post-thumb',
            template: __webpack_require__("../../../../../src/app/post-thumb/post-thumb.component.html"),
            styles: [__webpack_require__("../../../../../src/app/post-thumb/post-thumb.component.css")]
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__post_loader_service__["a" /* PostLoaderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__post_loader_service__["a" /* PostLoaderService */]) === "function" && _b || Object])
    ], PostThumbComponent);
    return PostThumbComponent;
    var _a, _b;
}());

//# sourceMappingURL=post-thumb.component.js.map
